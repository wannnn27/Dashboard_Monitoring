...
export const TASKS = {
  "Harus Dikerjakan": [
    { title: "Aerasi Tanah",     desc: "Aerasi tanaman dengan hati-hati tanpa merusak akar", time: "02:00 – 03:00 PM", due: "10 Sep, 2024" },
    { title: "Pembaruan Mulsa",  desc: "Buang mulsa lama, tambahkan lapisan segar ke tanah",  time: "03:00 – 03:30 PM", due: "10 Sep, 2024" },
  ],
  "Sedang Berjalan": [
    { title: "Inspeksi Saluran Tetes", desc: "Periksa saluran tetes dari kebocoran dan penyumbatan", time: "02:00 – 03:00 PM", due: "10 Sep, 2024", pct: 40 },
    { title: "Pencampuran Nutrisi",     desc: "Siapkan larutan nutrisi untuk tempat tanam",         time: "02:00 – 03:00 PM", due: "10 Sep, 2024", pct: 60 },
  ],
  "Dalam Peninjauan": [
    { title: "Kalibrasi Sensor Iklim", desc: "Kalibrasi sensor suhu dan kelembapan secara akurat.", time: "02:00 – 03:00 PM", due: "10 Sep, 2024", pct: 92 },
  ],
};
...
export const RECENT_UPDATES = [
  ...
  { label: "Tingkat irigasi disesuaikan", badge: "Penyiraman",   badgeClass: "badge-blue",   time: "9 Mei 2024" },
  { label: "Cahaya dioptimalkan",        badge: "Lingkungan",  badgeClass: "badge-yellow", time: "9 Mei 2024" },
];
